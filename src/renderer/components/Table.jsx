...
export default function Rtable({ number, occupied,SetSelectedTable }) {
  return (
    <div
      className='p-2 bg-blue-950 rounded-md flex flex-col cursor-pointer'
      onClick={()=>{SetSelectedTable(number)}}
    >
      <div className='text-center text-white font-bold'>
        <span>Table N°{number}</span>
      </div>
      <svg
        width={'120px'}
        height={'120px'}
        fill={occupied ? "#DF2E38" : "#03C988"}
        version="1.1"
        id="Capa_1"
